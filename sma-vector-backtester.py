...
Attributes
----------
symbol: str         RIC symbol with which to work
...
run_strategy:       runs the backtest for the SMA-based strategy
plot_results:       plots the performance of the strategy compared to the symbol
update_and_run:     updates SMA parameters and returns the (negative) absolute performance
optimize_parameters:    implements a brute force optimization for the two SMA parameters
'''
    ...
    def optimize_parameters(self, SMA1_range, SMA2_range):
        ...
        Parameters
        ----------
        SMA1_range, SMA2_range: tuple       tuples of the form (start, end, step size)
        '''
